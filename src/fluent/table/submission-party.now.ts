    ...
    schema: {
        ...
        role: StringColumn({
            ...
            choices: {
                ...
                subsidiary: { label: 'Subsidiary', sequence: 2 },
                additional_insured: { label: 'Additional Insured', sequence: 3 },
                broker: { label: 'Broker', sequence: 4 },
                leader: { label: 'Leader', sequence: 5 },
                reinsurer: { label: 'Reinsurer', sequence: 6 },
            },
        }),
